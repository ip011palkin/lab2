    ...
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                Console.WriteLine($"addition: {number1.ToString()} + {number2.ToString()} = {(number1 + number2).ToString()}");
                Console.WriteLine($"subtraction: {number1.ToString()} - {number3.ToString()} = {(number1 - number3).ToString()}");
                Console.WriteLine($"multiplication: {number1.ToString()} * {number4.ToString()} = {(number1 * number4).ToString()}");
                Console.WriteLine($"division: {number1.ToString()} / {number5.ToString()} = {(number1 / number5).ToString()}");
